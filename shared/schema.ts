...
export const ibkrTrades = pgTable("ibkr_trades", {
  ...
  tpHitLevel: integer("tp_hit_level").notNull().default(0),
  entryPrice: real("entry_price"),
  exitPrice: real("exit_price"),
  stopPrice: real("stop_price"),
  target1Price: real("target1_price"),
  target2Price: real("target2_price"),
  tp1FillPrice: real("tp1_fill_price"),
  tp2FillPrice: real("tp2_fill_price"),
  tp1PnlRealized: real("tp1_pnl_realized"),
  ...
  tp1FilledAt: text("tp1_filled_at"),
  tp2FilledAt: text("tp2_filled_at"),
