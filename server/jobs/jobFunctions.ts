      ...
      try {
        ...
        for (const setup of setups) {
          ...
          await storage.upsertSignal({
            ticker, setupType: setup.setupType, asofDate: setup.asofDate,
            targetDate: setup.targetDate, targetDate2: null, targetDate3: null,
            magnetPrice: setup.magnetPrice, magnetPrice2: setup.magnetPrice2 ?? null,
            ...
            timeScore: qualityResult.timeScore ?? null, universePass,
            activationStatus: "NOT_ACTIVE", activatedTs: null,
