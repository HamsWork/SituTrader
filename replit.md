...
- **ROI Insights:** Dedicated backtest edge analysis page showing setup rankings with activated win rates and lift, recommended strategy P&L simulation (best setup + top tickers + activated), equity curve and daily P&L charts, quality score breakdown, top/avoid ticker lists, and 1-trade-per-day selection guide. Filterable by setup type.
