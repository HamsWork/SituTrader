...
- **Performance ½ Study:** Split take-profit comparison page. Compares T1-Only (100% exit at T1) vs Split ½ (50% of shares at halfway point between entry and T1, remaining 50% at T1 or stop). Features comparison banner with delta P&L and winner badge, dual equity curve overlay, trade details table with halfway price and PARTIAL outcomes. MFE-based halfway hit detection for missed trades. Period-scoped.
